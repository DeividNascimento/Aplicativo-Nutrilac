            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.menu_inicio:
                        Intent intentInicio = new Intent(ListagemConcentradosActivity.this, HomeActivity.class);
                    ...
                    case R.id.menu_ajuda:
                        Toast.makeText(ListagemConcentradosActivity.this,"Essa tela ainda será desenvolvida",Toast.LENGTH_LONG).show();
                        break;
                    case R.id.menu_sairDaConta:
                        Intent intent = new Intent(ListagemConcentradosActivity.this, TelaPrimeiroAcessoActivity.class);
